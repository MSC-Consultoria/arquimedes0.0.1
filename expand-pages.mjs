...
// Conteúdo expandido para Página 2 de Adição (A Reta Numérica)
const adicaoPagina2 = `
...
<NumberLine start={0} end={15} highlight={[7, 11]} operation="7 + 4 = 11" />
...
console.log('Expandindo Página 2 de Adição (A Reta Numérica)...');
await db.update(pages)
  .set({ 
    mainText: adicaoPagina2,
    estimatedMinutes: 45,
    videoUrl: 'PLACEHOLDER_RETA_NUMERICA'
  })
  .where(eq(pages.id, 2));

console.log('✅ Página 2 de Adição expandida com sucesso!');
console.log('📊 Total de caracteres:', adicaoPagina2.length);
